...
function loadStats() {
    $.get('../api/weblinks.php?action=get_stats', function(stats) {
        const statsHtml = `
...
function loadTags() {
    $.get('../api/weblinks.php?action=get_tags', function(tags) {
        $('#bulkTags').empty();
        tags.forEach(tag => {
...
function uploadCSV() {
    ...
    $.ajax({
        url: '../api/weblinks.php?action=bulk_upload',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
function saveBulkTags() {
    ...
    $.ajax({
        url: '../api/weblinks.php?action=bulk_tags',
        type: 'POST',
...
function downloadTemplate() {
    ...
    form.method = 'GET';
    form.action = '../api/download_template.php';
