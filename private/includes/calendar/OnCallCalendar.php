...
class OnCallCalendar {
    ...
    public function __construct() {
        ...
        $this->modulePath = $projectRoot . '/scripts/modules/calendar';
        $this->dataPath = $projectRoot . '/data/oncall';
    ...
    private function executePythonScript($script, $args = []) {
        ...
        $modulesDir = dirname(dirname($this->modulePath));
        $env = ['PYTHONPATH' => $modulesDir];
